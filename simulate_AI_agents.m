...
winner = determine_winner(player_move, random_agent_move);
if strcmp(winner, 'player')
    win_matrix(1,end+1) = 0;
end
if strcmp(winner, 'AI')
    win_matrix(1,end+1) = 1;
end
if strcmp(winner, 'draw')
    win_matrix(1,end+1) = NaN;
end

%wslfds agent simulation
wslfds_agent_move = wslfds_agent(previous_move, previous_outcome);
winner = determine_winner(player_move, wslfds_agent_move);
if strcmp(winner, 'player')
    win_matrix(2,end) = 0;
end
if strcmp(winner, 'AI')
...
winner = determine_winner(player_move, wslsds_agent_move);
if strcmp(winner, 'player')
    win_matrix(4,end) = 0;
end
if strcmp(winner, 'AI')
...
winner = determine_winner(player_move, wslfdf_agent_move);
if strcmp(winner, 'player')
    win_matrix(5,end) = 0;
end
if strcmp(winner, 'AI')
...
winner = determine_winner(player_move, wslfdb_agent_move);
if strcmp(winner, 'player')
    win_matrix(6,end) = 0;
end
if strcmp(winner, 'AI')
...
winner = determine_winner(player_move, wslbdf_agent_move);
if strcmp(winner, 'player')
    win_matrix(7,end) = 0;
end
if strcmp(winner, 'AI')
...
winner = determine_winner(player_move, wslbdb_agent_move);
if strcmp(winner, 'player')
    win_matrix(8,end) = 0;
end
if strcmp(winner, 'AI')
...
winner = determine_winner(player_move, wslsdf_agent_move);
if strcmp(winner, 'player')
    win_matrix(9,end) = 0;
end
if strcmp(winner, 'AI')
...
winner = determine_winner(player_move, wslsdb_agent_move);
if strcmp(winner, 'player')
    win_matrix(10,end) = 0;
end
if strcmp(winner, 'AI')
...
winner = determine_winner(player_move, wblfdf_agent_move);
if strcmp(winner, 'player')
    win_matrix(11,end) = 0;
end
if strcmp(winner, 'AI')
...
winner = determine_winner(player_move, wblfdb_agent_move);
if strcmp(winner, 'player')
    win_matrix(12,end) = 0;
end
if strcmp(winner, 'AI')
...
winner = determine_winner(player_move, wblfds_agent_move);
if strcmp(winner, 'player')
    win_matrix(13,end) = 0;
end
if strcmp(winner, 'AI')
...
winner = determine_winner(player_move, wblbdf_agent_move);
if strcmp(winner, 'player')
    win_matrix(14,end) = 0;
end
if strcmp(winner, 'AI')
...
winner = determine_winner(player_move, wblbdb_agent_move);
if strcmp(winner, 'player')
    win_matrix(15,end) = 0;
end
if strcmp(winner, 'AI')
...
winner = determine_winner(player_move, wblbds_agent_move);
if strcmp(winner, 'player')
    win_matrix(16,end) = 0;
end
if strcmp(winner, 'AI')
...
winner = determine_winner(player_move, wblsdf_agent_move);
if strcmp(winner, 'player')
    win_matrix(17,end) = 0;
end
if strcmp(winner, 'AI')
...
winner = determine_winner(player_move, wblsdb_agent_move);
if strcmp(winner, 'player')
    win_matrix(18,end) = 0;
end
if strcmp(winner, 'AI')
...
winner = determine_winner(player_move, wblsds_agent_move);
if strcmp(winner, 'player')
    win_matrix(19,end) = 0;
end
if strcmp(winner, 'AI')
...
winner = determine_winner(player_move, wflfdf_agent_move);
if strcmp(winner, 'player')
    win_matrix(20,end) = 0;
end
if strcmp(winner, 'AI')
...
winner = determine_winner(player_move, wflfdb_agent_move);
if strcmp(winner, 'player')
    win_matrix(21,end) = 0;
end
if strcmp(winner, 'AI')
...
winner = determine_winner(player_move, wflfds_agent_move);
if strcmp(winner, 'player')
    win_matrix(22,end) = 0;
end
if strcmp(winner, 'AI')
...
winner = determine_winner(player_move, wflbdf_agent_move);
if strcmp(winner, 'player')
    win_matrix(23,end) = 0;
end
if strcmp(winner, 'AI')
...
winner = determine_winner(player_move, wflbdb_agent_move);
if strcmp(winner, 'player')
    win_matrix(24,end) = 0;
end
if strcmp(winner, 'AI')
...
winner = determine_winner(player_move, wflbds_agent_move);
if strcmp(winner, 'player')
    win_matrix(25,end) = 0;
end
if strcmp(winner, 'AI')
...
winner = determine_winner(player_move, wflsdf_agent_move);
if strcmp(winner, 'player')
    win_matrix(26,end) = 0;
end
if strcmp(winner, 'AI')
...
winner = determine_winner(player_move, wflsdb_agent_move);
if strcmp(winner, 'player')
    win_matrix(27,end) = 0;
end
if strcmp(winner, 'AI')
...
winner = determine_winner(player_move, wflsds_agent_move);
if strcmp(winner, 'player')
    win_matrix(28,end) = 0;
end
if strcmp(winner, 'AI')
